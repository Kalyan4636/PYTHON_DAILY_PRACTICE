#v Here is the source code of a Python program to solve the matrix-chain multiplication problem using dynamic programming with bottom-up approach. The program output is shown below.
